...
pub fn parse_calldata(data: String, rpc: Option<String>) -> Result<Calldata, ParsedCalldataError> {
...
mod tests {
    ...
    fn test_parse_calldata_1() {
        let res = parse_calldata("".to_owned(), None);
        let parsed_calldata = res.unwrap();
        assert_eq!(hex::encode(parsed_calldata.selector), "af989083");
        assert_eq!(hex::encode(parsed_calldata.nullifier), "1a0fe6f449922ed4173f73c77c7fff97cea27dbeb81188ec72ebec3c6ddc0f37");
        assert_eq!(hex::encode(parsed_calldata.out_commit), "0a3f732edcf1584a9b83d2baf55ed5a7613b7f4d2101bdcf5ce2c34d57008d65");
        ...
        assert_eq!(hex::encode(parsed_calldata.root_after), "015c913d6f602f0c161a239642bdd34d759adf71551abc76e335ae0706c65863");
    ...
    fn test_parse_calldata_2() {
        let res = parse_calldata("".to_owned(), None);
        let parsed_calldata = res.unwrap();
        assert_eq!(hex::encode(parsed_calldata.selector), "af989083");
        assert_eq!(hex::encode(parsed_calldata.nullifier), "2711712d54721af2e6acb4ebe63681baa29da74a6bf1b79419e949ed88cc5105");
        assert_eq!(hex::encode(parsed_calldata.out_commit), "229a17b5c68611cbfb9a85e0b7bb2d24673df1e3f6c35b199e324d12502d076f");
        ...
        assert_eq!(hex::encode(parsed_calldata.root_after), "22b822acd5c7cc53cfcdd57b57f65656d36b36f568723c881dd981e30558d6fe");
